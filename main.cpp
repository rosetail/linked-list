...
int main()
{
    ...
    PhoneBook ourPhoneBook; // Instantiation of PhoneBook object to contain
                            // contact names & phone numbers
    char userSelection;     // Variable for use in user interface
    Contact newContact;     // Buffer variable to contain new contact details to
                            // insert into list
    string fName;
    string lName;
    ...
    /*
     ...
     or print the list of contacts. The appropriate methods are called based on
     the users' selection, and the prompt repeats until the user chooses to
     quit.
     */
    bool quit = false;
    ...
    while (!quit)
    {
        ...
        // FIXED: 'insert new contact' selection now passes initialized Contact
        // to insert function
        case 'i':
